...
[Serializable]
[PostProcess(typeof(StylizedTonemapRenderer), PostProcessEvent.AfterStack, "Hidden/Noob/Stylized Tonemap")]
...
public sealed class StylizedTonemapRenderer : PostProcessEffectRenderer<StylizedTonemap>
{
    ...
    {
        var sheet = context.propertySheets.Get(Shader.Find("Hidden/Noob/Stylized Tonemap"));
